[tmlproject1paramv1-8c73] Details
============================
...
.. list-table::
   ...
   * - jsoncriteria
     - uid=uid=hostName,filter:allrecords~subtopics=hostName,hostName,hostName~values=inboundpackets,outboundpackets,pingStatus~identifiers=inboundpackets,outboundpackets,pingStatus~datetime=lastUpdated~msgid=~latlong=
...
.. list-table::
   ...
   * - context
     - These data are anomaly probabilities of suspicious data traffic. A high probability of over 0.80 is likely suspicious. probabilities are low, it is likely the device is not working properly.
   * - jsonkeytogather
     - hyperprediction
   * - keyattribute
